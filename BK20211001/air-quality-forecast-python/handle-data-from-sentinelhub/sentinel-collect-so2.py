...
# Set interval
f = open('air-quality-dataset/log/SO2-log.txt', 'r')
query_date = f.read()
while True:
  ...
  np.savetxt('air-quality-dataset/SO2/SO2-'+query_date +
              '.csv', response_data, delimiter=',')

  log_file = open('air-quality-dataset/log/SO2-log.txt', 'w')
  n = log_file.write(query_date)
  log_file.close()
  
  print("===Saved dataset " + 'SO2-'+query_date + '.csv')
