...
dist_list = {
    ...
    "q11": [10.763904275145594, 106., 203, 214],
...
path_to_dataset = 'air-quality-dataset/_DISTRICT-ALL/hcm.csv'
...
f = open('air-quality-dataset/log/district-all-log.txt', 'r')
query_date = f.read()
...
while True:
    ...
    log_file = open('air-quality-dataset/log/district-all-log.txt', 'w')
