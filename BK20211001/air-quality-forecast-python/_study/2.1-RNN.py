...
file_path = 'air-quality/air-quality-forecast-python/_study/dataset/weather.csv'
...
save_path = saver.save(sess, "air-quality/air-quality-forecast-python/_study/models/weather.ckpt")
...
with tf.Session() as sess:
  # Restore variables from disk.
    saver.restore(sess, "air-quality/air-quality-forecast-python/_study/models/model.ckpt")
