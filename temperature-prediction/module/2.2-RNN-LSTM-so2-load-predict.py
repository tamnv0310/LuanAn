...
# load the model
reconstructed_model = keras.models.load_model(dir_path+ '/models-py/rnn-lstm-so2', custom_objects=None, compile=True, options=None)

# load the scaler: with fit_transformed by the dataset
scaler = load(open(dir_path+ '/models-py/rnn-lstm-so2/scaler.pkl', 'rb'))
