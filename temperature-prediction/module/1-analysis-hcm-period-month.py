...
Data = Data[Data['date'] <= '2021-09-30 00:00:00']
...
_avg = Data.groupby(pd.PeriodIndex(Data['date'], freq="M"))['co', 'no2', 'o3', 'so2', 'ch4','hcho'].mean()*1000000
_min = Data.groupby(pd.PeriodIndex(Data['date'], freq="M"))['co', 'no2', 'o3', 'so2', 'ch4','hcho'].min()*1000000
_max = Data.groupby(pd.PeriodIndex(Data['date'], freq="M"))['co', 'no2', 'o3', 'so2', 'ch4','hcho'].max()*1000000
...
ax6.set(title="Formaldehyde - HCHO", xlabel="months", ylabel="µmol/m2")
ax6.legend(loc="best")

plt.suptitle("Air Quality in Ho Chi Minh City (January to September, 2021)")
plt.show()
